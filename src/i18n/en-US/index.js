export default {
  ...
  Account: {
    ...
    SecuritySetting: {
      ...
      HaveDoneGoogle: 'you have finish google authentication!!!'
    },
    History: {
  ...
  Faq: {
    ...
    D: 'Questions About Procyon',
    E: 'I looked up your company on Google, but nothing came up. Is PRCN Technology Ltd. a company set up just for this platform? Are you backed by any large capital investors?',
    F: 'As with the whole cryptocurrency industry, PRCN Technology is a relatively new venture. We understand if you feel that such a new field of investment deserves scrutiny. However, please know that our team has over a decade of collective industry experience in blockchain and cryptocurrency technologies.',
    K: 'Questions About Spacemesh',
    R: 'Questions About Mining',
    Search: 'Search',
  },
