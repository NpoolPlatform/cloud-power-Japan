export default {
  ...
  Account: {
    Email: {
      Update: {
        Title: "メールの更新",
        OldEmailInput: "旧メールアドレスを入力してください。",
      ...
      Enable: {
        Title: "電子メールの有効化",
        EmailInput: "メールアドレス",
        EmailInputWarning: "正しいメールアドレスを入力してください。",
        VerifyCode: "メールでのコード確認",
        VerifyCodeWarning: "検証コードを入力してください。",
        Btn: "電子メールの有効化",
      },
    ...
    Phone: {
      Update: {
        Title: "携帯電話の更新",
        OldPhoneInput: "旧電話番号を入力してください。",
        PhoneWarning: "正しい電話番号を入力してください。",
        VerifyCode: "電話番号認証コード",
        VerifyCodeWarning: "検証コードを入力してください。",
        PhoneInput: "新しい電話番号を入力してください。",
        Btn: "携帯電話の更新",
      },
      Enable: {
        Title: "電話の有効化",
        PhoneInput: "電話番号",
        PhoneInputWarning: "正しい電話番号を入力してください。",
        VerifyCode: "電話番号認証コード",
        VerifyCodeWarning: "検証コードを入力してください。",
        Btn: "電話の有効化",
      },
    ...
    SecuritySetting: {
      EmailEnable: "メールアドレスを有効にする",
      PhoneEnable: "電話番号を有効にする",
      EmailUpdate: "メールアドレスの更新",
      PhoneUpdate: "電話番号の更新",
      Title: "セキュリティ設定",
  ...
  ChangePassword: {
    ...
    Phone: {
      PhoneInput: "電話番号",
      PhoneInputWarning: "お客様の電話番号を入力してください。",
    },
    ConfirmBtn: "確認",
  },
  ...
  Faq: {
    ...
    Header3: {
      ...
      A2: "BTCやその他の暗号通貨の価格は日々変動が激しいため、価格が米ドルに紐づいている変動しづらいコインUSDT（別名Tether）での支払いとして表記させていただいております。これには、お客様のお支払いの安定性と正確性を保つ意図があります。お客様のお支払い金額に関する具体的なお問い合わせは、support@procyon.vip へご連絡ください。",
      Q3: "「TiB」とは?",
      A3: "TiBは、Terabyte (テラバイト) の略であり、コンピューターのハードディスクの容量を表す単位です。ハードディスクを使ってマイニングする暗号通貨、例えばSpacemeshの場合、ストレージパワー（ストレージを使わない暗号通貨のマイニングではハッシュパワーとも呼ばれる）はTiBの単位で測定されます。",
    },
  ...
  Legal: {
    ...
    hh11: "11. 連絡方法",
    pp13: "本プライバシーポリシーに対してのご質問がある場合、support@procyon.vipへお問い合わせください。",
