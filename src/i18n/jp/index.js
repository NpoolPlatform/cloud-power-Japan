export default {
  ...
  Homepage: {
    ...
    Feature: {
      ...
      TopTeam: "ドリームチーム",
      TopTeamContent:
        "Procyonの創業者たちやパートナー企業は、暗号通貨市場で10年以上の経験を持ち、投資利回りが100倍以上のプロジェクトに多数投資してきています。当社の技術チームは5年以上に渡り、1億6千万米ドル以上の資産を管理してきました。",
      Technology: "全体像",
      TechnologyContent:
  ...
  Account: {
    ...
    SecuritySetting: {
      ...
      Mobile: "携帯電話の認証",
      MobileContent:
        "携帯電話の認証で、ログイン、入出金、その他セキュリティ設定の変更を行うことができます。",
      ...
      IDVerificationContent:
        "身分を証明する画像付きの証明書をアップロードしてください。",
      IDVerificationBtn: "身分証明書を設定",
      Verify: "設定済み",
      NotVerify: "設定を行う",
      Enable: "設定済み",
      NotEnable: "設定を行う",
      GoogleVerify: "Google2段階認証",
      LoginVerification: "ログイン認証",
      LoginVerificationContent:
        "ログイン時のセキュリティを強化するため、認証方法を有効にすることができます。",
