export default {
  ...
  CodeFail: {
    Fail1: "入力コードエラー",
    Fail2: "認証コードの有効期限が切れているか、間違っています。",
  },
  ...
  Register: {
    ...
    PhoneInputWarning2: "携帯番号の頭の「0」は、記入不要",
  ...
  Login: {
    ...
    UsernameInputwarning:
      "正しいユーザー名／メールアドレスを入力してください。",
    PasswordInputWarning: "パスワードが違います。",
    PhoneLogin: "電話番号でログイン",
    EmailLogin: "メールでログイン",
    EmailVerifyTitle: "メール認証",
    PasswordError: "パスワードの入力ミス",
    UserNotFound: "ユーザが見つからない、存在しない",
  },
  ...
  GoogleVerify: {
    Title: "Google認証コード",
    Content:
      "お客様は、Google認証によるログイン認証を選択しています。Google認証アプリに表示されている認証コードを記入ください。",
