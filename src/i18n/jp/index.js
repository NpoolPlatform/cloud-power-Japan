export default {
  ...
  Homepage: {
    ...
    Feature: {
      ...
      TopTeam: "ドリームチーム",
      TopTeamContent:
        "Procyonの創業者たちやパートナー企業は、暗号通貨市場で10年以上の経験を持ち、投資利回りが100倍以上のプロジェクトに多数投資してきています。当社の技術チームは5年以上に渡り、1億6千万米ドル以上の資産を管理してきました。カスタマーサービス部門は、ハーフや帰国子女など、バイリンガルなメンバーで構成されており、英語と日本語での連絡が可能となっております。基本的に24時間以内に対応し、質の高い、優れたカスタマーサービスを提供することに力を注いでいます。",
      Technology: "全体像",
      TechnologyContent:
        "暗号通貨市場は、研究開発→VCファンド→マイナー→取引所と流れ、最終的にトークンが一般投資家に分配されます。Procyonでは、通常は機関投資家にしか提供されない機会を見つけ出すだけでなく、個人投資家にも機会を提供することを目指しています。",
    },
    ...
    Why: {
      ...
      Content5:
        "広範なネットワークと独自のリサーチ能力により、普通はアクセスすることができない独占的な機会をお届けします。",
      Content6:
        "日本は一人当たりの投資額がアジアで最も高い国です。日本市場は多くの",
    ...
    What: {
      ...
      Content2:
        "マイニングの難易度が1番低いタイミングで開始することを意味します。真っ先にマイニングを開始することで、マイニング量が1番高い状態の時に参加することができ、結果としてより大きな投資利回りを得ることができます。",
      Content3: "マイニングの投資利回りに影響を与える要素は2つあります。",
      Content4: "マイニング量",
      Content5: "トークン価格",
      Content6:
        "マイニング量は、マイニングの難易度に直結します。マイナーが多いほど、ネットワーク全体のハッシュパワーの合計は大きくなり、マイニング難易度が上昇すると、マイナー1人当たりのマイニング量は比例して低くなります。マイニング可能な総供給量は基本的に固定されている為、マイニングに使用されるハッシュパワーが多くなればなるほど、ハッシュパワーの単位（TB）あたりのマイニング量は少なくなります。 ",
      Content7:
        "通常のマイニングに比べて、ファーストバッチマイニングのマイニング量は格段に多いです。 ",
      Content8:
      ...
      Content12:
        "通常、ファーストバッチマイニングはプロのマイナーや機関投資家、もしくは経験豊富なマイニングプールでなければ参加することができません。Procyonは、個人投資家もファーストバッチマイニングに参加することを可能にし、より優れたタイミングでの投資機会を提供することを目指したハイエンドなプラットフォームです。",
  ...
  Account: {
    ...
    SecuritySetting: {
      ...
      Mobile: "携帯電話の認証",
      MobileContent:
        "携帯電話の認証で、ログイン、入出金、その他セキュリティ設定の変更を行いましょう。",
      MobileBtn: "携帯電話の設定を変更",
      Google: "Google認証",
      GoogleContent:
        "2段階認証を設定する事で、アカウントから入出金する際のセキュリティを強化する事ができます。",
      GoogleBtn: "2段階認証を設定",
      IDVerification: "身分証明の設定",
      IDVerificationContent:
        "身分を証明する画像付きの証明書をアップロードしましょう。",
  ...
  Legal: {
    ...
    hh11: "11. 連絡方法",
    pp13: "本プライバシーポリシーに関するお問い合わせは、こちらまでお願いいたします。",
