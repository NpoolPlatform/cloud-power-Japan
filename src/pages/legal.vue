  ...
  <div>
    <div id="main">
      <div class="content legal">
        ...
        <ul>
          <li>1. pursuant to a decision or ruling of a court, arbitral body, or other judicial proceeding.</li>
          <li>2. as required by the relevant government authority.</li>
          <li>3. the user violates the terms of use or has other actions that are detrimental to the interests of the mining leasing platform.</li>
          <li>4. Other requirements of relevant laws and regulations.</li>
        </ul>
        ...
        <ul>
          <li>(1) Losses on transactions.</li>
          <li>(2) Trading profits or contract losses.</li>
          <li>(3) Business interruption.</li>
          <li>(4) Loss of information.</li>
          <li>(5) Damage or loss of data.</li>
          <li>(6) The demise or withdrawal of computing power from the market.</li>
          <li>(7) Losses due to policy factors.</li>
          <li>(8) Losses due to force majeure.</li>
        </ul>
        <p>Since its inception, Procyon has been committed to serving the mining industry, providing miners with a full range of services, from mining machine procurement, maintenance, mine deployment, and revenue exchange, etc. The Cloud Mining Service has grown from an internal operation to an official operation today. From its inception to its official operation today, Cloud Power Mining Service is based on the investment philosophy of 'rejecting partial distribution of profits and transparent operation of computing power,' and this innovation aims to build the world's best computing power service platform for users. To provide quality, algorithmic trading services to maximize the profits of our supportive friends and clients.</p>
        <p>Anyone who logs in or uses (including direct and indirect use) the Procyon website in any way is deemed to have accepted and approved this statement. The contents of this statement are made in accordance with the relevant laws of the Republic of Seychelles, and the contents of this statement will be interpreted and applied in accordance with the relevant laws of the Republic of Seychelles.</p>
        <h1>Privacy Policy</h1>
        <h2>Privacy Policy</h2>
        <p>We respect the privacy of all users and site visitors (collectively called “you” and “your”) and promise to do our best to protect your online privacy. This Privacy policy outlines the process of management, collection, maintenance and processing of users’ personal data by, Procyon and its affiliated entities (hereinafter referred to as the “Procyon” or “we”, “us” and “our”).</p>
        ...
        <ul>
          <li>(1) Show you our site and its contents;</li>
          <li>(2) Identify you as our users in our system;</li>
          <li>(3) Process your orders;</li>
          <li>(4) Provide customer services;</li>
          <li>(5) Respond to your requirements;</li>
          <li>(6) Provide you with product updates;</li>
          <li>(7) Improve our site;</li>
          <li>(8) Send news, investigations, special offers and other promotional materials relating to our products;</li>
          <li>(9) Communicate with you;</li>
          <li>(10) Manage the risks and protect the site and protect our services and you from fraudulent activities;</li>
          <li>(11) Comply with all applicable laws and regulations, and execute the service agreements of both this site and Procyon;</li>
          <li>(12) Other purposes with your consent.</li>
        </ul>
        ...
        <p>Our services may contain links to third-party websites that are not operated by us. If you click such links, you will be directed to the relevant third-party websites. The Privacy Policy does not apply to other third-party websites. We strongly recommend that you check the privacy policies of the websites you visit. Procyon can neither control any third-party websites or their contents of services and privacy policies, nor bear any responsibility.</p>
